window.ONYX_TOKENS = [
  {
    ...
    clubTiers: [
      { name: "Genesis Member", min: 1, icon: "\u{1F7E2}" },
      { name: "Whale", min: 5, icon: "\u{1F40B}" },
      { name: "Council", min: 10, icon: "\u{1F5A4}" },
    ],
    whaleTopN: [1, 3, 5, 10],
  },
  {
    ...
    clubTiers: [
      { name: "Starter", min: 100, icon: "\u{1F7E2}" },
      { name: "Builder", min: 1000, icon: "\u{1F535}" },
      { name: "Operator", min: 10000, icon: "\u{1F7E3}" },
    ],
    whaleTopN: [1, 3, 5, 10],
  },
  {
