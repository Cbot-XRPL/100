...
window.ONYX_TOKENS = [
  {
    ...
    description:
      "XAH the native asset on Xahau, priced directly in USD for this dashboard",
    badgeRules: [],
  ...
  },
  {
    ...
    heroLogoUrl: "./media/emoji-100-gold-circle.svg",
    logoRounded: false,
    excludeIssuer: false,
    excludedAddresses: ["rone8WK6YKtfSXPdYyZrKqJCVd5dqB9GM"],
    logo: "100",
    theme: "genesis",
